    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl shadow-lg p-6">
        ...
        <p className="text-blue-100">
          ...
          . Sistem ini digunakan untuk memantau penerimaan, pengeluaran, serta
          posisi saldo RKUD secara real-time.
        </p>
      </div>
      ...
      {/* <div className="grid md:grid-cols-3 gap-6">
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition">
          ...
          <p className="text-xs text-gray-400 mt-1">Total penerimaan RKUD</p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition">
          ...
          <p className="text-xs text-gray-400 mt-1">Total pengeluaran RKUD</p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition">
          ...
          <p className="text-xs text-gray-400 mt-1">Saldo terakhir RKUD</p>
        </div>
      </div> */}
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h3 className="text-lg font-semibold text-gray-800">Data Saldo</h3>
          </div>

          <p className="text-gray-600 text-sm mb-4">
            Lihat data penerimaan dan pengeluaran RKUD serta analisis posisi
            saldo harian.
          </p>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h3 className="text-lg font-semibold text-gray-800">Input Saldo</h3>
          </div>

          <p className="text-gray-600 text-sm mb-4">
            Tambahkan data penerimaan atau pengeluaran RKUD untuk memperbarui
            posisi saldo sistem.
          </p>

          <button
            onClick={() => navigate("/saldo/input")}
